...
////		profile.operation.bids.submitted_demand_inflex(price_demand_inflex_ID) += sol[4];
...
////		}
////		else{
//////			profile.operation.bids.submitted_demand_inflex(price_demand_flex_ID + price_gap) += avail_demand_EV / 3.;
