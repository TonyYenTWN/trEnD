...
namespace power_network{
	...
	void HELM_Transmission_Update(int, network_inform&, power_market::market_whole_inform&);
	...
	void power_flow_results_print(power_market::market_whole_inform&, network_inform&, configuration::process_config&);
}
