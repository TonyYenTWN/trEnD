...
- [cbt_forecast_2021.csv](https://github.com/TonyYenTWN/trEnD/blob/main/csv/case/trial/input/power_market/cbt_forecast_2021.csv) stores the time series of scheduled cross border transmission flows of the modeled bidding zones and their directly connected neighbors. Since there can be two directions of transmission flow between 2 connected bidding zones, each connection contributes to 2 columns of time series.
- [control_reserve_activated_2021.csv](https://github.com/TonyYenTWN/trEnD/blob/main/csv/case/trial/input/power_market/control_reserve_activated_2021.csv) stores the time series of activated control reserve in the modeled bidding zones. Since the activated control reserve can be both positive and negative, each bidding zone contributes to 2 columns of time series.
