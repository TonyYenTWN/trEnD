# trEnD: Model for Transition of End-users and the Distribution Power Network![alt text](https://github.com/TonyYenTWN/trEnD/blob/main/logos/main_logo.jpg?raw=true)
