...
fractal_power <- 1
reference_power_dc <- 2000
reference_power_ac <- 0
reference_power_dc_diff_1 <- 0
reference_power_dc_diff_2 <- 0
reference_edge_dc_diff_1 <- 0
reference_edge_dc_diff_2 <- 0
...
<!-- title for toc -->
## - Residual Load Profile {.tabset .tabset-fade .tabset-pills}

### Node 40 {.tabset .tabset-fade .tabset-pills}

#### Jan
```{r RL profile node 40 jan, echo = FALSE, message = FALSE, warning = FALSE}
setwd(parent_dir)
...
TSO_actual_ref <- TSO_actual_demand - TSO_actual_supply
...
TSO_actual_part <- TSO_actual_demand - TSO_actual_supply
...
TSO_actual_full <- TSO_actual_demand - TSO_actual_supply

operation_plot_temp <- plot_ly(type = 'scatter', mode = 'lines') %>%
  layout(showlegend = T, 
...
operation_plot_temp <- operation_plot_temp %>%
  layout(
  yaxis = list(showgrid = F, showline = T, title = "Residual Demand (GWh)")
  )
operation_plot_temp <- operation_plot_temp %>%
  add_trace(x = timestamp_01, y = (TSO_actual_ref[,40] + TSO_actual_ref[,73] + TSO_actual_ref[,112]) / 1000, 
  name = "Reference") %>%
  # add_trace(x = timestamp_01, y = (TSO_actual_part[,40] + TSO_actual_part[,73] + TSO_actual_part[,112]) / 1000, name = "Partially Flexible") %>%
  add_trace(x = timestamp_01, y = (TSO_actual_full[,40] + TSO_actual_full[,73] + TSO_actual_full[,112]) / 1000, name = "Fully Flexible")
operation_plot_temp <- operation_plot_temp %>%
  config(
    toImageButtonOptions = list(
      format = "svg",
...
#### July
```{r RL profile node 40 jul, echo = FALSE, message = FALSE, warning = FALSE}
setwd(parent_dir)
...
```{r RL profile node 88 jan, echo = FALSE, message = FALSE, warning = FALSE}
setwd(parent_dir)
...
operation_plot_temp <- operation_plot_temp %>%
  add_trace(x = timestamp_01, y = (TSO_actual_ref[,76] + TSO_actual_ref[,88]) / 1000, 
  name = "Reference") %>%
  # add_trace(x = timestamp_01, y = (TSO_actual_part[,76] + TSO_actual_part[,88]) / 1000, name = "Partially Flexible") %>%
  add_trace(x = timestamp_01, y = (TSO_actual_full[,76] + TSO_actual_full[,88]) / 1000, 
  name = "Fully Flexible")
operation_plot_temp <- operation_plot_temp %>%
  config(
    toImageButtonOptions = list(
...
#### January specific
```{r dc power flow jan ref 01 specific, echo = FALSE, message = FALSE, warning = FALSE}
setwd(parent_dir)
...
node_average_balance <- apply(TSO_actual_supply[320,] - TSO_actual_demand[320,], 2, mean)
edge_average_flow <- apply(abs(TSO_actual_DC_power[320,]), 2, mean)
...
#### January Average
```{r dc power flow jan ref 01 avg, echo = FALSE, message = FALSE, warning = FALSE}
setwd(parent_dir)
...
# node_average_balance_01[40]
# node_average_balance_02[40]
# node_average_balance[40]
...
### Difference Active - Ref 1 {.tabset .tabset-fade .tabset-pills}

#### January Specific
```{r dc power flow jan active - ref 1, echo = FALSE, message = FALSE, warning = FALSE}
setwd(parent_dir)
...
# node_average_balance_01 <- apply(TSO_actual_supply - TSO_actual_demand, 2, mean)
# edge_average_flow_01 <- apply(abs(TSO_actual_DC_power), 2, mean)
node_average_balance_01 <- apply(TSO_actual_supply[320,] - TSO_actual_demand[320,], 2, mean)
edge_average_flow_01 <- apply(abs(TSO_actual_DC_power[320, ]), 2, mean)
edge_average_flow_01 <- edge_average_flow_01 / edge_data[, 3]
...
# node_average_balance_02 <- apply(TSO_actual_supply - TSO_actual_demand, 2, mean)
# edge_average_flow_02 <- apply(abs(TSO_actual_DC_power), 2, mean)
node_average_balance_02 <- apply(TSO_actual_supply[275,] - TSO_actual_demand[275,], 2, mean)
edge_average_flow_02 <- apply(abs(TSO_actual_DC_power[275, ]), 2, mean)
edge_average_flow_02 <- edge_average_flow_02 / edge_data[, 3]
...
for(node_iter in 1:length(node_average_balance)){
  if(node_average_balance[node_iter] < 0){
    fraction <- -node_average_balance[node_iter] / reference_power
    color_type = paste("rgb(", 255, ", 0, 0)", sep = "")
  }else{
    fraction <- node_average_balance[node_iter] / reference_power
    color_type = paste("rgb(0,", 200, ", 0)", sep = "")
  }
...
#### January Average
```{r dc power flow jan active - ref 1 avg, echo = FALSE, message = FALSE, warning = FALSE}
setwd(parent_dir)
...
node_average_balance_01 <- apply(TSO_actual_supply - TSO_actual_demand, 2, mean)
edge_average_flow_01 <- apply(abs(TSO_actual_DC_power), 2, mean)
# node_average_balance_01 <- apply(TSO_actual_supply[275,] - TSO_actual_demand[275,], 2, mean)
# edge_average_flow_01 <- apply(abs(TSO_actual_DC_power[275, ]), 2, mean)
edge_average_flow_01 <- edge_average_flow_01 / edge_data[, 3]
...
#### July
```{r dc power flow jul active - ref 1, echo = FALSE, message = FALSE, warning = FALSE}
setwd(parent_dir)
...
node_average_balance_01 <- apply(TSO_actual_supply - TSO_actual_demand, 2, mean)
edge_average_flow_01 <- apply(abs(TSO_actual_DC_power), 2, mean)
# node_average_balance_01 <- apply(TSO_actual_supply[108,] - TSO_actual_demand[300,], 2, mean)
# edge_average_flow_01 <- apply(abs(TSO_actual_DC_power[108, ]), 2, mean)
edge_average_flow_01 <- edge_average_flow_01 / edge_data[, 3]
...
node_average_balance_02 <- apply(TSO_actual_supply - TSO_actual_demand, 2, mean)
edge_average_flow_02 <- apply(abs(TSO_actual_DC_power), 2, mean)
# node_average_balance_02 <- apply(TSO_actual_supply[108,] - TSO_actual_demand[300,], 2, mean)
# edge_average_flow_02 <- apply(abs(TSO_actual_DC_power[108, ]), 2, mean)
edge_average_flow_02 <- edge_average_flow_02 / edge_data[, 3]
